...
Human-readable update notes for the `1.40.8` reference set.

## Install

- Instance: `<instance-root>\1.40.8`
- Managed assemblies: `<instance-root>\1.40.8\Beat Saber_Data\Managed`
- Assembly inventory: `../references/versions/1.40.8/managed-index.md`
- Compact type index: `../references/versions/1.40.8/types-game.jsonl`
