...
- Assembly name: HoudiniEngineUnity

## Version Presence

| Version | State | Category | Assembly version | Bytes | SHA256-12 |
| --- | --- | --- | ---: | ---: | --- |
| 1.29.1 | present | third-party | 0.0.0.0 | 551936 | 3daa160b2b29 |
| 1.40.8 | present | third-party | 0.0.0.0 | 573440 | 3f00fabf03ee |
| 1.44.0 | absent |  |  |  |  |

## Changes

- 1.29.1 to 1.40.8: changed
- 1.40.8 to 1.44.0: removed
